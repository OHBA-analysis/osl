...
SRC_DIR = "/well/woolrich/projects/mrc_meguk/notts/eo/src"

SMRI_FILE = "/well/woolrich/projects/mrc_meguk/notts/eo/smri/{0}_T1w.nii.gz"
PREPROC_FILE = (
    PREPROC_DIR + "/{0}_task-resteyesopen_meg/{0}_task-resteyesopen_meg_preproc_raw.fif"
)
