...
if run_sensorspace:
    ...
    if False:
        ...
        recon_timeseries_mni, reference_brain_fname, recon_coords_mni, recon_indices = rhino.transform_recon_timeseries(
            subjects_dir, subject,
        ...
        for ii in range(3):
            leadfield2save[:,ii] = np.reshape(leadfield, [273, -1, 3])[:, int(recon_indices[vox]), ii]
